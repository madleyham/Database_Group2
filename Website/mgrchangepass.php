...
<?PHP
	if(isset($_POST['changepass']))
	{
		...
		$query = "SELECT PASSWORD FROM MGR_LOGIN WHERE ID = '$id' and password ='$old_pass'";
		...
		if($row)
		{
			$query = "UPDATE MGR_LOGIN SET password ='$new_pass' WHERE ID = '$id' and password ='$old_pass'";
			$parseRequest = oci_parse($conn, $query);
			oci_execute($parseRequest);
		...
		<div id="content">
			...
			<div id="slideshow">
				...
				<div class="container" style="position: absolute; top: 50px; left: 400px; " align="center">
					...
					<form action='mgrchangepass.php' method='post'>
